...
import {
    ...
    FiSearch, FiCalendar, FiMapPin, FiCreditCard, FiTrendingUp, FiDollarSign, FiShoppingCart
} from 'react-icons/fi';
...
const AdminOrderManagementPage = () => {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            ...
            try {
                ...
                // Perform analysis after fetching data
                performAnalysis(ordersData, items);
            } catch (err) {
    ...
    const performAnalysis = (orders, orderItems) => {
        ...
        const avgPrice = revenue / orders.length;
        setAverageOrderPrice(avgPrice);
        ...
        const mostSold = Object.values(orderItems)
            .flat()
            .find(item => item.product_id._id === mostSoldProductId)?.product_id;
                ...
                <div className="mb-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <p className="text-gray-600">Most Sold Product</p>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <p className="text-gray-600">Average Order Price</p>
                                <p className="font-semibold">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <div className="flex items-center space-x-4">
                            <FiShoppingCart className="text-2xl text-purple-500" />
                            <div>
